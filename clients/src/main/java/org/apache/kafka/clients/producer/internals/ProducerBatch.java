...
public final class ProducerBatch {
	...
	public String toString() {
		return "ProducerBatch [createdMs=" + createdMs + ", topicPartition=" + topicPartition + ", produceFuture="
				+ produceFuture + ", thunks=" + thunks + ", recordsBuilder=" + recordsBuilder + ", attempts=" + attempts
				+ ", isSplitBatch=" + isSplitBatch + ", finalState=" + finalState + ", recordCount=" + recordCount
				+ ", maxRecordSize=" + maxRecordSize + ", lastAttemptMs=" + lastAttemptMs + ", lastAppendTime="
				+ lastAppendTime + ", drainedMs=" + drainedMs + ", expiryErrorMessage=" + expiryErrorMessage
				+ ", retry=" + retry + "]";
	}
