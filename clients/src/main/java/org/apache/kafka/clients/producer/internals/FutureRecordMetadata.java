...
public final class FutureRecordMetadata implements Future<RecordMetadata> {
	...
	public String toString() {
		return "FutureRecordMetadata [result=" + result + ", relativeOffset=" + relativeOffset + ", createTimestamp="
				+ createTimestamp + ", checksum=" + checksum + ", serializedKeySize=" + serializedKeySize
				+ ", serializedValueSize=" + serializedValueSize + ", nextRecordMetadata=" + nextRecordMetadata + "]";
	}
