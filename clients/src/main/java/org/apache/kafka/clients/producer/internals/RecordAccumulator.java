 ...
 */
/**
 * 这个类充当一个队列（累加器），将记录积累到要批量发送到服务器的实例中, 
 * 累加器使用有限的内存，当内存耗尽时，追加调用会阻塞，除非该行为被显式禁止
 * @author 001
 *
 */
public final class RecordAccumulator {
    ...
    public ReadyCheckResult ready(Cluster cluster, long nowMs) {
    	log.info("【RecordAccumulator ready nowMs："+ nowMs +"】");
    ...
    public final static class RecordAppendResult {
		...
		public String toString() {
			return "RecordAppendResult [future=" + future + ", batchIsFull=" + batchIsFull + ", newBatchCreated="
					+ newBatchCreated + "]";
		}
    ...
    public final static class ReadyCheckResult {
		...
		@Override
		public String toString() {
			return "ReadyCheckResult [readyNodes=" + readyNodes + ", nextReadyCheckDelayMs=" + nextReadyCheckDelayMs
	...
	@Override
	public String toString() {
		return "RecordAccumulator [closed=" + closed + ", flushesInProgress=" + flushesInProgress
				+ ", appendsInProgress=" + appendsInProgress + ", batchSize=" + batchSize + ", compression="
				+ compression + ", lingerMs=" + lingerMs + ", retryBackoffMs=" + retryBackoffMs + ", free=" + free
				+ ", time=" + time + ", apiVersions=" + apiVersions + ", batches=" + batches + ", incomplete="
				+ incomplete + ", muted=" + muted + ", drainIndex=" + drainIndex + ", transactionManager="
				+ transactionManager + "]";
	}
