...
public class NetworkClient implements KafkaClient {
    ...
    public List<ClientResponse> poll(long timeout, long now) {
    	log.info("【NetworkClient poll abortedSends.isEmpty():"+ abortedSends.isEmpty() +"】");
        ...
        completeResponses(responses);
        log.info("【List<ClientResponse> ："+ responses.toString() +"】");
        return responses;
    }
	...
	public String toString() {
		return "NetworkClient [selector=" + selector + ", metadataUpdater=" + metadataUpdater + ", randOffset="
				+ randOffset + ", connectionStates=" + connectionStates + ", inFlightRequests=" + inFlightRequests
				+ ", socketSendBuffer=" + socketSendBuffer + ", socketReceiveBuffer=" + socketReceiveBuffer
				+ ", clientId=" + clientId + ", correlation=" + correlation + ", requestTimeoutMs=" + requestTimeoutMs
				+ ", reconnectBackoffMs=" + reconnectBackoffMs + ", time=" + time + ", discoverBrokerVersions="
				+ discoverBrokerVersions + ", apiVersions=" + apiVersions + ", nodesNeedingApiVersionsFetch="
				+ nodesNeedingApiVersionsFetch + ", abortedSends=" + abortedSends + ", throttleTimeSensor="
				+ throttleTimeSensor + "]";
	}
