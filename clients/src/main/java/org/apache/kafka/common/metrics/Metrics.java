...
public class Metrics implements Closeable {
  ...
  /**
	...
	public String toString() {
		return "Metrics [config=" + config + ", metrics=" + metrics + ", sensors=" + sensors + ", childrenSensors="
				+ childrenSensors + ", reporters=" + reporters + ", time=" + time + ", metricsScheduler="
				+ metricsScheduler + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
