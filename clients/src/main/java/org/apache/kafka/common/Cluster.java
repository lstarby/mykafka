...
public final class Cluster {
	...
	public String toString() {
		return "Cluster [isBootstrapConfigured=" + isBootstrapConfigured + ", nodes=" + nodes + ", unauthorizedTopics="
				+ unauthorizedTopics + ", internalTopics=" + internalTopics + ", controller=" + controller
				+ ", partitionsByTopicPartition=" + partitionsByTopicPartition + ", partitionsByTopic="
				+ partitionsByTopic + ", availablePartitionsByTopic=" + availablePartitionsByTopic
				+ ", partitionsByNode=" + partitionsByNode + ", nodesById=" + nodesById + ", clusterResource="
				+ clusterResource + "]";
	}
